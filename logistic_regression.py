...
if __name__ == "__main__":
    ...
    # datatest=([1,50000],[6,5000],[10,50000])
    #
    # print(logistic(dot( datain for datain in datatest)))

    test1 =[1,50000]
    test2 =[6,5000]
    test3 =[10,50000]

    print(logistic(dot(beta_hat, test1)))
    print(logistic(dot(beta_hat, test2)))
    print(logistic(dot(beta_hat, test3)))