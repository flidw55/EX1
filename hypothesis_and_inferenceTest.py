...
from probabilityTest import normal_cdf, inverse_normal_cdf
...
if __name__ == "__main__":
    ...
    print "normal_two_sided_bounds(0.68, mu_0, sigma_0)", normal_two_sided_bounds(0.68, mu_0, sigma_0)
    print "normal_two_sided_bounds(0.95, mu_0, sigma_0)", normal_two_sided_bounds(0.95, mu_0, sigma_0)
    print "normal_two_sided_bounds(0.997, mu_0, sigma_0)", normal_two_sided_bounds(0.997, mu_0, sigma_0)
    print "normal_two_sided_bounds(0.5, mu_0, sigma_0)", normal_two_sided_bounds(0.5, mu_0, sigma_0)
    print "normal_two_sided_bounds(0.9, mu_0, sigma_0)", normal_two_sided_bounds(0.9, mu_0, sigma_0)
